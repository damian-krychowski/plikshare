...
public class Api(IFlurlClient flurlClient, string appUrl)
{
    ...
    public QuickShareExternalAccessApi QuickShareExternalAccess = new(flurlClient, appUrl);
    ...
    public AgentsApi Agents { get; } = new(flurlClient, appUrl);
    ...
    public AuditLogPolicyApi AuditLogPolicy { get; } = new(flurlClient, appUrl);
