...
export class StorageSizeUtils {
    ...
    private static readonly MB = StorageSizeUtils.KB * 1024;
    private static readonly GB = StorageSizeUtils.MB * 1024;
    private static readonly TB = StorageSizeUtils.GB * 1024;
