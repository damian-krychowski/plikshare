...
public static class AuditLogEventCatalog
{
    ...
    [
        ...
        new(AuditLogEventTypes.Agent.WorkspaceMembersListed,                AuditLogEventCategories.Agent, AuditLogSeverities.Info,    "Agent listed the members of a workspace.",            AuditLogEventScope.Application),
        new(AuditLogEventTypes.Agent.BoxesListed,                           AuditLogEventCategories.Agent, AuditLogSeverities.Info,    "Agent listed the boxes of a workspace.",              AuditLogEventScope.Application),
        new(AuditLogEventTypes.Agent.BoxViewed,                             AuditLogEventCategories.Agent, AuditLogSeverities.Info,    "Agent viewed the details of a box.",                  AuditLogEventScope.Application),
        new(AuditLogEventTypes.Agent.BoxLinksListed,                        AuditLogEventCategories.Agent, AuditLogSeverities.Info,    "Agent listed the links of a box.",                    AuditLogEventScope.Application),
        new(AuditLogEventTypes.Agent.BoxMembersListed,                      AuditLogEventCategories.Agent, AuditLogSeverities.Info,    "Agent listed the members of a box.",                  AuditLogEventScope.Application),
