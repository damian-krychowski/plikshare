...
/// <summary>
/// Resolves a get_share_link operation's stored id into the share link's name, so a human reviewing
/// the approval sees which public link the agent wants to inspect.
/// </summary>
public class GetShareLinkOperationDetailsResolver(
    PlikShareDb plikShareDb)
{
    public GetShareLinkOperationDetails Resolve(AgentOperation operation)
    {
        ...
        return new GetShareLinkOperationDetails
        {
