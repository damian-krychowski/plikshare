...
/// <summary>
/// Resolves a create_box_folder operation's stored parameters into the box name, the new folder's name
/// and the full location of its parent, so a human reviewing the approval sees what gets created and
/// where.
/// </summary>
public class CreateBoxFolderOperationDetailsResolver(
    BoxApprovalNameResolver boxNameResolver,
    AuditLogService auditLogService)
{
    public CreateBoxFolderOperationDetails Resolve(AgentOperation operation)
    {
        ...
        return new CreateBoxFolderOperationDetails
        {
