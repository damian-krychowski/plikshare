...
/// <summary>
/// Resolves a bulk_delete operation's stored ids into the actual folder and file names (and their
/// paths and parent folders) so a human can see exactly what the agent wants to delete.
/// </summary>
public class BulkDeleteOperationDetailsResolver(
    AuditLogService auditLogService,
    PlikShareDb plikShareDb)
{
    public BulkDeleteOperationDetails Resolve(AgentOperation operation)
    {
